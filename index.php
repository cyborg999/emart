            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 padding-fix-l20">
                        <div class="owl-carousel owl-slider owl-loaded owl-drag">
                            
                            
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1670px, 0px, 0px); transition: all 0s ease 0s; width: 5010px;"><div class="owl-item cloned" style="width: 835px;"><div class="slider-item slider-item1">
                                <img src="./index_files/girl-1.png" alt="" class="img1 wow fadeInRight effect" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInRight;">
                                <div class="slider-box">
                                    <div class="slider-table">
                                        <div class="slider-tablecell">
                                            <div class="wow fadeInUp effect" data-wow-duration="1.2s" data-wow-delay="0.5s" style="visibility: visible; animation-duration: 1.2s; animation-delay: 0.5s; animation-name: fadeInUp;">
                                                <h5>Big Sale</h5>
                                            </div>
                                            <div class="wow fadeInUp effect" data-wow-duration="1.2s" data-wow-delay="0.6s" style="visibility: visible; animation-duration: 1.2s; animation-delay: 0.6s; animation-name: fadeInUp;">
                                                <h2>New Product Collection</h2>
                                            </div>
                                            <div class="wow fadeInUp effect" data-wow-duration="1.2s" data-wow-delay="0.7s" style="visibility: visible; animation-duration: 1.2s; animation-delay: 0.7s; animation-name: fadeInUp;">
                            ...
                            </div></div><div class="owl-item cloned" style="width: 835px;"><div class="slider-item slider-item2">
                                <img src="./index_files/girl-2.png" alt="" class="img2 wow fadeInRight effect" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInRight;">
                                <div class="slider-box">
                                    <div class="slider-table">
                            ...
                            </div></div><div class="owl-item active" style="width: 835px;"><div class="slider-item slider-item1">
                                <img src="./index_files/girl-1.png" alt="" class="img1 wow fadeInRight effect" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInRight;">
                                <div class="slider-box">
                                    <div class="slider-table">
                                        <div class="slider-tablecell">
                            ...
                            </div></div><div class="owl-item" style="width: 835px;"><div class="slider-item slider-item2">
                                <img src="./index_files/girl-2.png" alt="" class="img2 wow fadeInRight effect" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInRight;">
                                <div class="slider-box">
                                    <div class="slider-table">
                                        <div class="slider-tablecell text-right">
                            ...
                            </div></div><div class="owl-item cloned" style="width: 835px;"><div class="slider-item slider-item1">
                                <img src="./index_files/girl-1.png" alt="" class="img1 wow fadeInRight effect" data-wow-duration="1s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: fadeInRight;">
                                <div class="slider-box">
                                    <div class="slider-table">
                                        <div class="slider-tablecell">
        ...
        <section class="product-area hidden">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="bt-deal">
                                    ...
                                    <div class="bt-body owl-carousel owl-loaded owl-drag">
                            ...
                            <div class="col-md-12">
                                <div class="ht-offer">
                                    ...
                                    <div class="ht-body owl-carousel owl-loaded owl-drag">
                            ...
                            <div class="col-md-12">
                                <div class="hm-test">
                                    <div class="test-body owl-carousel owl-loaded owl-drag">
                                        
                                        
                                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-476px, 0px, 0px); transition: all 0s ease 0s; width: 1428px;"><div class="owl-item cloned" style="width: 213px; margin-right: 25px;"><div class="test-item text-center">
                                            <img src="./index_files/test-1.jpg" alt="" class="img-fluid">
                                            <h6>John Doe</h6>
                                            <span>Photographer</span>
                                            <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore."</p>
                                        </div></div><div class="owl-item cloned" style="width: 213px; margin-right: 25px;"><div class="test-item text-center">
                                            <img src="./index_files/test-2.jpg" alt="" class="img-fluid">
                                            <h6>Eric Shell</h6>
                                            <span>Developer</span>
                                            <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore."</p>
                                        </div></div><div class="owl-item active" style="width: 213px; margin-right: 25px;"><div class="test-item text-center">
                                            <img src="./index_files/test-1.jpg" alt="" class="img-fluid">
                                            <h6>John Doe</h6>
                                            <span>Photographer</span>
                                            <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore."</p>
                                        </div></div><div class="owl-item" style="width: 213px; margin-right: 25px;"><div class="test-item text-center">
                                            <img src="./index_files/test-2.jpg" alt="" class="img-fluid">
                                            <h6>Eric Shell</h6>
                                            <span>Developer</span>
                                            <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore."</p>
                            ...
                            <div class="col-md-12">
                                <div class="top-rtd">
                                    ...
                                    <div class="rt-slider owl-carousel owl-loaded owl-drag">
                        ...
                        <div class="row">
                                ...
                                <div class="ftr-product">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="all" role="tabpanel">
                                            <div class="tab-slider owl-carousel owl-loaded owl-drag">
                            ...
                            <div class="col-md-12 padding-fix-l20">
                                <div class="top-slr">
                                    ...
                                    <div class="slr-slider owl-carousel owl-loaded owl-drag">
                    ...
                    <div class="col-md-12">
                        <div class="tp-bnd owl-carousel owl-loaded owl-drag">
